document.addEventListener("DOMContentLoaded", async () => {
    ...
    async function runFaceRecognition() {
        ...
        elements.video.parentNode.appendChild(elements.canvas);
        ...
        async function detect() {
            ...
            faceapi.draw.drawFaceExpressions(elements.canvas, resizedDetections, 0.05);
